...
import sprites.OctopusLoader;

public class Octopus extends Enemy{
	private Animation octopusRun;
	private boolean facingRight;
	private float stateTimer;
	private State curState;
	private State prevState;
	private OctopusLoader animationLoader;
	private World world;
	private Type type;
	private float x;
	private float y;
	...
	public Octopus(World world, TextureAtlas at, float x, float y, PlayScreen owner) {
		super(world, owner);
		...
		animationLoader = new OctopusLoader(at);
		
		octopusRun = animationLoader.getRunning();	
	}
	...
	private void defineOctopus(World world){
	...
	public OctopusLoader getLoader() {
	...
	public TextureRegion getFrame(float dt) {
		...
		switch(curState){
			case RUNNING:
				tr = octopusRun.getKeyFrame(stateTimer, true);
				break;
			case STANDING:
			default:
